---
name: explorer-46
description: Round-1 divergent exploration agent (Opus 4.6). Reads the explorer brief and produces a structured exploration of the research problem.
...
Output destination: `runs/round-1/46.md`. Overwrite if it exists.
...
After writing the file, output ONE line in chat: `Round 1 complete: 46`. Then stop. Do not summarize, do not echo content.
