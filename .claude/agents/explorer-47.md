---
name: explorer-47
description: Round-1 divergent exploration agent (Opus 4.7). Reads the explorer brief and produces a structured exploration of the research problem.
...
Output destination: `runs/round-1/47.md`. Overwrite if it exists.
...
After writing the file, output ONE line in chat: `Round 1 complete: 47`. Then stop. Do not summarize, do not echo content.
